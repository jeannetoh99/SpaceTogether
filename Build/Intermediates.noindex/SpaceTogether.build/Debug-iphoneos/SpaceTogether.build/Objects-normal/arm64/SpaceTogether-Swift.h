...
#ifndef SPACETOGETHER_SWIFT_H
#define SPACETOGETHER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpaceTogether",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13SpaceTogether19AlarmViewController")
...
SWIFT_CLASS("_TtC13SpaceTogether11AppDelegate")
...
SWIFT_CLASS("_TtC13SpaceTogether27BlueTraceLocalNotifications")
@interface BlueTraceLocalNotifications : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface BlueTraceLocalNotifications (SWIFT_EXTENSION(SpaceTogether)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
@end


SWIFT_CLASS("_TtC13SpaceTogether17CentralController")
...
@interface CentralController (SWIFT_EXTENSION(SpaceTogether)) <CBPeripheralDelegate>
...
@interface CentralController (SWIFT_EXTENSION(SpaceTogether)) <CBCentralManagerDelegate>
...
@interface Encounter (SWIFT_EXTENSION(SpaceTogether))
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@property (nonatomic, copy) NSString * _Nullable msg;
@property (nonatomic, copy) NSString * _Nullable modelC;
@property (nonatomic, copy) NSString * _Nullable modelP;
@property (nonatomic, strong) NSNumber * _Nullable rssi;
@property (nonatomic, strong) NSNumber * _Nullable txPower;
@property (nonatomic, copy) NSString * _Nullable org;
@property (nonatomic, strong) NSNumber * _Nullable v;
@end


SWIFT_CLASS("_TtC13SpaceTogether20PeripheralController")
...
@interface PeripheralController (SWIFT_EXTENSION(SpaceTogether)) <CBPeripheralManagerDelegate>
...
SWIFT_CLASS("_TtC13SpaceTogether13SceneDelegate")
...
SWIFT_CLASS("_TtC13SpaceTogether14ViewController")
